<%@page import="memberAction.MemberBean"%>
<%@page import="orderAction.OrderBean"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    
<%
OrderBean order = (OrderBean)request.getAttribute("order");
MemberBean ordermember = (MemberBean)request.getAttribute("oredermember");
%>
<!DOCTYPE html>
<html>
<head>
...
<table width="960" cellspacing="0" cellpadding="0" border="0"
	...
	<tr>
		...
		width=130 height=24 bgcolor="f7f7f7">
		운송장(등기)번호
		</td>
